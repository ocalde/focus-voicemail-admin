...
export const { beginUpdate, endUpdate, populate, changeStatus } = configSlice.actions;
...
export const selectMessages = state => state.config.data;
export const selectMessageUpdating = state => state.config.updating;
